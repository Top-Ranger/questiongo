...
<td class="centre" bgcolor="#5EFF5E" title="{{$e.Display}} - ✓" onclick="e=document.getElementById('{{$e.ID}}_✓');if(!e.disabled){e.checked=true;}"><input title="{{$e.Display}} - ✓" type="radio" id="{{$e.ID}}_✓" name="{{$e.ID}}" value="✓" {{if $e.Disabled}} disabled {{end}}></td>
<td class="centre" bgcolor="#FFE75E" title="{{$e.Display}} - 👎" onclick="e=document.getElementById('{{$e.ID}}_👎');if(!e.disabled){e.checked=true;}"><input title="{{$e.Display}} - 👎" type="radio" id="{{$e.ID}}_👎" name="{{$e.ID}}" value="👎" {{if $e.Disabled}} disabled {{end}}></td>
<td class="centre" bgcolor="#FF5E66" title="{{$e.Display}} - X" onclick="e=document.getElementById('{{$e.ID}}_X');if(!e.disabled){e.checked=true;}"><input title="{{$e.Display}} - X" type="radio" id="{{$e.ID}}_X" name="{{$e.ID}}" value="X" {{if $e.Disabled}} disabled {{end}}></td>
<td class="centre" bgcolor="#DBD9E2" title="{{$e.Display}} - ?" onclick="e=document.getElementById('{{$e.ID}}_?');if(!e.disabled){e.checked=true;}"><input title="{{$e.Display}} - ?" type="radio" id="{{$e.ID}}_?" name="{{$e.ID}}" value="?" {{if $e.Disabled}} disabled {{end}}></td>
</tr>
{{end}}
</tbody>
</table>
