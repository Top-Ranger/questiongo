...
func init() {
	...
	cleanPolicy.AllowElements("img")
	cleanPolicy.AllowStandardURLs()
	cleanPolicy.AllowImages()
	defaultPolicy = bluemonday.NewPolicy()
	defaultPolicy.AllowElements("a", "b", "blockquote", "br", "caption", "code", "del", "div", "em", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "i", "ins", "img", "kbd", "mark", "p", "pre", "q", "s", "samp", "strong", "sub", "sup", "u")
